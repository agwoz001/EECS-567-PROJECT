...
%%%%% add y offset to everything as robot falls.
    ...
    line([joint3(1) end3(1)],[joint3(2) end3(2)])
    jointsize=0.2;
    ...
    rectangle('Position',[joint3(1)-jointsize/2,joint3(2)-jointsize/2,jointsize,jointsize],'Curvature',[1 1])
    ...
    rectangle('Position',[center3(1)-jointsize/2,center3(2)-jointsize/2,jointsize,jointsize],'EdgeColor','r')
